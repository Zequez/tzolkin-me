        ...
        <div className={"w-screen fixed flex flex-col min-h-screen bg-gray-50"}>
            ...
            <div className={"flex m-4 mt-0 h-10"}>
                ...
                <button
                    onClick={addTodo}
                    className={
                        "flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-500 focus:outline-none focus:border-green-700 focus:shadow-outline-blue active:bg-blue-700 transition duration-150 ease-in-out"
                    }
                >
                    Add
                </button>
